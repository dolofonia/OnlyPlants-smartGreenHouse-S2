...
void sw_init(void){
    ...
    PORTA->PCR[4] = PORT_PCR_IRQC(9) | PORT_PCR_MUX(1);
    PORTA->PCR[12]= PORT_PCR_IRQC(9) | PORT_PCR_MUX(1);
    PORTA->PCR[2] = PORT_PCR_IRQC(9) | PORT_PCR_MUX(1);// | PORT_PCR_PS(1) | PORT_PCR_PE(1)
		PORTA->PCR[1] = PORT_PCR_IRQC(9) | PORT_PCR_MUX(1);
		PORTD->PCR[4] = PORT_PCR_IRQC(9) | PORT_PCR_MUX(1);	
